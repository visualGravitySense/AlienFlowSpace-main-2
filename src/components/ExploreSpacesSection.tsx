...
const getSpaces = () => [{
  ...
  icon: <img src={assetUrl("/lovable-uploads/AcademyLogo.png")} alt="Academy" className="h-10 w-10 object-contain" />,
  link: '/academy'
}, {
  id: 'clubs',
  title: 'Clubs',
  ...
  icon: <img src={assetUrl("/lovable-uploads/ClubLogo.png")} alt="Clubs" className="h-10 w-10 object-contain" />,
  link: '/clubs'
}, {
  id: 'conetworking',
  title: 'CoNetWorKing',
  ...
  icon: <img src={assetUrl("/lovable-uploads/CoNetWorKingLogo.png")} alt="CoNetWorKing" className="h-10 w-10 object-contain" />,
  link: '/conetworking'
}];
